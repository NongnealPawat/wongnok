...
<head>
  ...
  <style>
    ...
    .title-card {
      background-image: url(https://sites.google.com/site/foogthai4/_/rsrc/1484626393316/xahar-thiy-4-phakh/xahar-praca-phakh-klang/work1%20038.JPG);
      height: 22rem;
...
<body class="bg-light">
  ...
  <main class="container text-center">
    <div class="title-card">
      <h2 class="title-card__subtext">ร้านอาหารเด็ดภาคกลาง ที่ไม่ควรมองข้าม!</h2>
    </div>
    <section class="mt-4 mb-4 d-flex gap-4 flex-column">
      <?php
      $sql = "SELECT * FROM restaurants WHERE sectorId = 3";
