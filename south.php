...
<head>
  ...
  <style>
    ...
    .title-card {
      background-image: url(https://s.isanook.com/tr/0/rp/r/w850/ya0xa0m1w0/aHR0cHM6Ly9zLmlzYW5vb2suY29tL3RyLzAvdWQvMjgzLzE0MTY5MjcvZ3Jnci5qcGc=.jpg);
      height: 22rem;
...
<body class="bg-light">
  ...
  <main class="container text-center">
    <div class="title-card">
      <h2 class="title-card__subtext">ร้านอาหารเด็ดภาคใต้ ที่ไม่ควรมองข้าม!</h2>
    </div>
    <section class="mt-4 mb-4 d-flex gap-4 flex-column">
      <?php
      $sql = "SELECT * FROM restaurants WHERE sectorId = 2";
